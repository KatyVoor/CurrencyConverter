## React Native Applicaiton that serves as a basic currency converter.
Made as a project demo to learn more about React Native in preparation to make a larger app (see IIH) in other repositiories.
